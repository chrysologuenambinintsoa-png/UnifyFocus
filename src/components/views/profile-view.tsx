...
> = {
  free: {
    ...
    features: [
      ...
      "5 uploads/jour",
      "3 générations de musique/jour",
      "3 générations de vidéo/jour",
  ...
  pro: {
    ...
    features: [
      "1000 crédits/mois",
      "Générations illimitées par rapport au gratuit",
      "Priorité sur les files d'attente IA",
      "Accès aux générations avancées",
      "Support prioritaire",
      "Exports et réglages avancés",
    ],
    icon: Crown,
  },
  enterprise: {
    ...
    features: [
      ...
      "Priorité maximale et SLA",
      "Intégrations et workflows sur mesure",
    ],
    icon: Shield,
  },
};
